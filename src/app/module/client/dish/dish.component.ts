  ...
  ngOnInit(): void {
    ...
    const seo = {
      vi: {
        ...
        description: 'Khám phá danh sách các món ăn hấp dẫn, đa dạng và phù hợp với khẩu vị của bạn tại What To Eat.',
        keywords: 'món ăn, thực đơn, ẩm thực, what to eat, món ngon, gợi ý món ăn, công thức nấu ăn'
      },
      en: {
        title: 'Dishes | What To Eat',
        description: 'Discover a variety of delicious dishes and recipes tailored to your taste at What To Eat.',
        keywords: 'dishes, menu, cuisine, what to eat, delicious food, food suggestion, recipe'
      }
    };
