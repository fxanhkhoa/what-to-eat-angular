...
export class VotingComponent implements OnInit, OnDestroy {
  ...
  private addOrUpdateCanonicalLink() {
    ...
    if (this.localeID.startsWith('vi')) {
      canonicalUrl = `${baseUrl}/vi/voting`;
    } else {
      canonicalUrl = `${baseUrl}/en/voting`;
    }
  ...
  private addHrefLangLinks() {
    ...
    viLink.setAttribute('href', `${baseUrl}/vi/voting`);
    ...
    enLink.setAttribute('href', `${baseUrl}/en/voting`);
    ...
    defaultLink.setAttribute('href', `${baseUrl}/en/voting`);
